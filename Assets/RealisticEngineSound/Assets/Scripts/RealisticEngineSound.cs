...
public class RealisticEngineSound : MonoBehaviour 
{
    ...
    public float spatialBlend = 0f; // this value should always be 1. If you want custom value, remove spatialBlend = 1f; line from Start()
    [Range(0.1f, 2.0f)]
    ...
    private void Start()
    {
        spatialBlend = 0.2f; // remove this line if you want to set custom values for spatialBlend
